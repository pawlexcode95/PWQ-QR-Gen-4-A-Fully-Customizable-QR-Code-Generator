...
class PWQ_QR_GEN_4():
    ...
    def create_text_format_object(segs: list[PWQ_QR_Segmentation], text: str, eclvl: PWQ_QR_GEN_4.PWQ_QR_Ecl, ver: int, mask: int) -> PWQ_QR_GEN_4:
        """
...
"""
        ...
        self._bytedatacw = PWQ_QR_GEN_4.create_text_format_object(segs, self._input_txt, self._eclvl, self._version, self._mask)
